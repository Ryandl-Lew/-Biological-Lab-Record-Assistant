...
public interface ReviewUseCase {
    ...
    ReviewDtos.RevisionView submit(
            UUID userId, UUID recordId, ReviewDtos.SubmitRequest request, String idempotencyKey);

    ReviewDtos.RevisionView requestChanges(
            UUID userId, UUID recordId, UUID reviewId, String comment);
