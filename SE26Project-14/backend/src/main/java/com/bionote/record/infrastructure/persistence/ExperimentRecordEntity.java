...
class ExperimentRecordEntity {
    ...
    @Column(name = "field_values_json", nullable = false, columnDefinition = "TEXT")
    String fieldValuesJson;

    @Column(name = "content_json", nullable = false, columnDefinition = "TEXT")
    String contentJson;

    @Column(name = "content_html_sanitized", nullable = false, columnDefinition = "TEXT")
    String contentHtmlSanitized;

    @Column(name = "content_plain_text", nullable = false, columnDefinition = "TEXT")
    ...
    ExperimentRecordEntity(
        ...
        this.contentHtmlSanitized = contentHtmlSanitized;
