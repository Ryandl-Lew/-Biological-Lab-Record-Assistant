...
class RestoreOperationEntity {
    ...
    @Column(name = "before_record_version", nullable = false)
    long beforeVersion;

    @Column(name = "after_record_version", nullable = false)
    long afterVersion;
    ...
    @Column(name = "after_content_hash", nullable = false, length = 64)
    @JdbcTypeCode(SqlTypes.CHAR)
    String afterHash;

    @Column(name = "diff_summary_json", nullable = false, columnDefinition = "TEXT")
