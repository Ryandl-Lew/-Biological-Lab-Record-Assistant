...
public class User {
    ...
    public User(
            UUID id, String displayName, String emailNormalized, String passwordHash, Instant now) {
        this.id = id;
    ...
    public void setAvatarStorageKey(String value) {
        avatarStorageKey = value;
    }
    ...
    public void setAvatarMimeType(String value) {
