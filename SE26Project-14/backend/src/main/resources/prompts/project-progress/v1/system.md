...
in one response. Inspect only records needed to support material progress and risks. As soon as
the evidence is sufficient, stop calling tools and return the final JSON object.
