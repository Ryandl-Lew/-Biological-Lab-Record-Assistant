...
class RealProviderSmokeTest {
    ...
    void normalizesToolCallingAndStructuredJsonWithoutSendingBioNoteData() {
        ...
        String system =
                "This is a provider adapter smoke test using synthetic data only. "
                        + "First call get_synthetic_demo_fact exactly once. Do not answer from memory.";
        AgentModelRequest firstRequest =
        ...
        outputSchema.set(
                "required",
                json.createArrayNode().add("schemaVersion").add("status").add("evidenceRef"));
        String finalSystem =
        ...
        AgentModelRequest secondRequest =
                new AgentModelRequest(
                        runId,
                        promptId,
                        properties.getModel(),
                        ...
                        List.of(
                                new AgentModelRequest.ModelMessage(
                                        ...
                                        null),
                                new AgentModelRequest.ModelMessage(
                                        "assistant", null, null, null, List.of(call)),
                                new AgentModelRequest.ModelMessage(
                                        "tool",
        ...
        assertThat(finalResponse.finalOutput().path("evidenceRef").asText())
