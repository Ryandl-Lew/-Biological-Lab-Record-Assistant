...
public class BioNoteAgentTools {
    ...
    public record PlotChartInput(String chartType, String xColumn, String yColumn, String csvFilename){}
    public record FitDataInput(String equation, String xColumn, String yColumn, Boolean autoCompare){}
}
