...
public final class AgentDtos {
    ...
    public record FitComparisonView(String equation,Double rSquared,Double rmse,int n,boolean selected){}
    public record SuggestedEvidenceFitView(String purpose, String xHint, String yHint, String note){}
    ...
    public record FitView(String equation,Map<String,Double> parameters,double rSquared,double rmse,int n,List<String> usedRecordCodes,List<FitSkipView> skipped,List<FitCurvePoint> curveSample,List<FitPointView> points,List<FitComparisonView> comparisons){}
