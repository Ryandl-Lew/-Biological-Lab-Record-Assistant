...
public class ChatMessageEntity {
    ...
    @Column(columnDefinition = "TEXT") String metadata;
    @Column(name = "created_at", nullable = false) Instant createdAt;

    public ChatMessageEntity() {}
    public ChatMessageEntity(UUID id, UUID sessionId, String role, String content, String metadata, Instant createdAt) {
        this.id = id; this.sessionId = sessionId; this.role = role; this.content = content; this.metadata = metadata; this.createdAt = createdAt;
    }
