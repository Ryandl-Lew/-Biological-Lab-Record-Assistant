...
class AgentChatReferenceEntity {
    ...
    @Column(name = "uploaded_by", nullable = false) @JdbcTypeCode(SqlTypes.CHAR) UUID uploadedBy;
    ...
    @Column(name = "peek_json", nullable = false, columnDefinition = "TEXT") String peekJson;
    @Column(name = "created_at", nullable = false) Instant createdAt;
    @Column(name = "expires_at", nullable = false) Instant expiresAt;

    protected AgentChatReferenceEntity() {}
    AgentChatReferenceEntity(UUID id,UUID projectId,UUID uploadedBy,String storageKey,String originalFilename,
                             String contentType,long sizeBytes,String peekJson,Instant createdAt,Instant expiresAt) {
        this.id=id;this.projectId=projectId;this.uploadedBy=uploadedBy;this.storageKey=storageKey;
        this.originalFilename=originalFilename;this.contentType=contentType;this.sizeBytes=sizeBytes;
        this.peekJson=peekJson;this.createdAt=createdAt;this.expiresAt=expiresAt;
    }
}
