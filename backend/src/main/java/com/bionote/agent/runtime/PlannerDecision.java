...
public sealed interface PlannerDecision
        permits PlannerDecision.ExecuteTools, PlannerDecision.Finish, PlannerDecision.Fail {
    record ExecuteTools(List<ModelToolCall> invocations) implements PlannerDecision {
        public ExecuteTools {
