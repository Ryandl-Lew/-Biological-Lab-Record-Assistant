...
public interface AgentRunStore {
    ...
    int finishRunning(UUID runId, String status, String errorCode, String errorMessage, Instant now);
    ...
    long countRecentMatching(UUID subjectId, String artifactKind, String payloadHash, Instant cutoff);

    record NewRun(UUID id, String artifactKind, String subjectType, UUID subjectId, UUID projectId,
