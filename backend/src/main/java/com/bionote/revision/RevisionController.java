...
public class RevisionController {
    private final RevisionQueryService queries;
    private final RevisionDiffService diffs;
    public RevisionController(RevisionQueryService queries, RevisionDiffService diffs) { this.queries = queries; this.diffs = diffs; }
