...
public class ExportController {
    private final ExportUseCase service;public ExportController(ExportUseCase service){this.service=service;}private UUID current(Authentication a){return UUID.fromString(a.getName());}
    @GetMapping("/preview") ApiResponse<ExportDtos.Preview> preview(Authentication a,@PathVariable UUID recordId){return ApiResponse.of(service.preview(current(a),recordId));}
