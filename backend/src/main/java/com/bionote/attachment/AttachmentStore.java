...
public interface AttachmentStore {
    ...
    record AttachmentRecord(UUID id, UUID recordId, UUID uploaderId, String originalFilename, String storageKey,
                            String mediaType, long sizeBytes, boolean previewable, Instant createdAt, Instant deletedAt) {}
}
