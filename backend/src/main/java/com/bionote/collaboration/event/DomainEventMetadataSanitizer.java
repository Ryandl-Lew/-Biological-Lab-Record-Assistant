...
public class DomainEventMetadataSanitizer {
    ...
    private static final Map<String, Set<String>> SAFE_KEYS = Map.of(
            "RECORD_REVISION_RESTORED", Set.of("revisionNo", "sourceRevisionId", "fromVersion", "toVersion", "changedSections", "attachmentAdded", "attachmentRemoved"),
            "AGENT_RUN_REQUESTED", Set.of("runId", "artifactKind", "triggerType", "status"),
            "AGENT_RUN_SUCCEEDED", Set.of("runId", "artifactKind", "triggerType", "status", "artifactId"),
            "AGENT_RUN_FAILED", Set.of("runId", "artifactKind", "triggerType", "status", "errorCode"),
    ...
    private Object safeValue(Object value) {
        ...
        if (value instanceof CharSequence text) {
            ...
            return result.length() <= MAX_STRING_LENGTH ? result : result.substring(0, MAX_STRING_LENGTH);
        }
