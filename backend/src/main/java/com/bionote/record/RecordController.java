...
public class RecordController {
    private final RecordUseCase service;public RecordController(RecordUseCase service){this.service=service;}private UUID current(Authentication a){return UUID.fromString(a.getName());}
