...
public class JpaUserRepositoryAdapter implements UserRepository {
    ...
    @Override public Optional<User> findById(UUID id) { return repository.findById(id); }
    @Override public Optional<User> findByEmailNormalized(String email) { return repository.findByEmailNormalized(email); }
    @Override public boolean existsByEmailNormalized(String email) { return repository.existsByEmailNormalized(email); }
