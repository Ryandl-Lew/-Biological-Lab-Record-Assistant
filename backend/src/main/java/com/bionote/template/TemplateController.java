...
public class TemplateController {
    private final TemplateUseCase service;public TemplateController(TemplateUseCase service){this.service=service;}private UUID current(Authentication a){return UUID.fromString(a.getName());}
