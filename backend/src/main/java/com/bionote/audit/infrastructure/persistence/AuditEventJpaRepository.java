...
interface AuditEventJpaRepository extends JpaRepository<AuditEventEntity,UUID> {
    ...
    @Query(value="""
            ...
            """,nativeQuery=true)
    int appendOnce(@Param("id") String id,@Param("actorId") String actorId,@Param("projectId") String projectId,
                   @Param("recordId") String recordId,@Param("eventType") String eventType,
                   @Param("targetType") String targetType,@Param("targetId") String targetId,
                   @Param("metadata") String metadata,@Param("createdAt") Instant createdAt);
}
