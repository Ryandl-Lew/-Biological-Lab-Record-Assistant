...
class NotificationEntity {
    ...
    @Column(name="recipient_id",nullable=false) @JdbcTypeCode(SqlTypes.CHAR) UUID recipientId;
    ...
    @Column(name="dedup_key",nullable=false,length=200,unique=true) String dedupKey;
