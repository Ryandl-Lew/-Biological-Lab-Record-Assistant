...
public interface NotificationStore {
    ...
    record NotificationRecord(UUID id,UUID recipientId,String type,String title,String body,String payloadJson,
                              String dedupKey,Instant createdAt,Instant readAt) {}
