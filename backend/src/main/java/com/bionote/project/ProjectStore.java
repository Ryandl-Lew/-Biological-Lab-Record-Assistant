...
public interface ProjectStore {
    ...
    PageSlice searchForMember(UUID userId, String status, String escapedKeyword, int page, int size);
    int archiveActive(UUID projectId, Instant now);
    long recordCount(UUID projectId);

    record ProjectRecord(UUID id, String name, String description, String detailedDescription, String status,
                         UUID ownerId, Instant createdAt, Instant updatedAt, Instant archivedAt, long version) {}
