...
class PointExtractorCsvTest {
    ...
    void parsesCsvWithHeaderNames() {
        ...
        List<FitModels.DataPoint> points = extractor.parseCsv(csv, UUID.randomUUID(), "EXP-1", "concentration", "ct");
    ...
    void parsesCsvByColumnIndex() {
        String csv = "0.5,1.5\n1.0,2.0\n1.5,2.5\n";
        List<FitModels.DataPoint> points = extractor.parseCsv(csv, UUID.randomUUID(), "EXP-2", "0", "1");
        assertThat(points).hasSize(3);
