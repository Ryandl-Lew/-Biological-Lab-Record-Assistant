...
class FitProposalResolverMultiColumnTest {
    ...
    void prefersLatestYAndXOverOlderResidualSugarHistory() {
        ...
        FitProposalResolver resolver =
                new FitProposalResolver(
                        props, new ObjectMapper(), new FitIntentParser(new ObjectMapper()));
        String catalog =
                "file=\"新建 Microsoft Excel 工作簿.xlsx\" columns=[时间, 发酵长度, PH, 温度, 搅拌, 溶氧, 通风量, 耗碱量（显示值）, 补糖量, 残糖, OD, 备注]";
        String message =
                """
