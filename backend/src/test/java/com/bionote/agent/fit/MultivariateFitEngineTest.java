...
class MultivariateFitEngineTest {
    ...
    void fitsSimplePlane() {
        ...
        FitModels.FitResult result = engine.fit(List.of("x1", "x2"), "y", x, y, List.of(), List.of("R1"));
    ...
    void dropsDuplicateAndConstantColumnsInsteadOfFailing() {
        ...
        FitModels.FitResult result = engine.fit(
                List.of("t", "t_dup", "const", "noise"), "sugar", x, y, List.of(), List.of("R1"));
