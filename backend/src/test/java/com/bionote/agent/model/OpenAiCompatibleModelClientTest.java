...
class OpenAiCompatibleModelClientTest {
    ...
    @Test void enabledAdapterRequiresAllConfiguration(){AgentProperties properties=new AgentProperties();properties.setEnabled(true);properties.setProvider("openai-compatible");assertThatThrownBy(()->new OpenAiCompatibleModelClient(properties,new ObjectMapper())).isInstanceOf(IllegalStateException.class).hasMessageContaining("AGENT_BASE_URL");}
