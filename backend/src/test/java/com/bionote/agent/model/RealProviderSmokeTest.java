...
class RealProviderSmokeTest {
    ...
    void normalizesToolCallingAndStructuredJsonWithoutSendingBioNoteData() {
        ...
        properties.setBaseUrl(required("AGENT_BASE_URL"));
        properties.setApiKey(required("AGENT_API_KEY"));
        properties.setModel(required("AGENT_MODEL"));
    ...
    private String required(String name) {
        ...
        if (value == null || value.isBlank()) {
            throw new IllegalStateException(name + " is required for the explicit real-provider smoke test");
        }
        return value;
    }
}
