    ...
    <section>
      ...
      <div className="mx-auto grid max-w-5xl items-start gap-6 lg:grid-cols-[320px,minmax(0,1fr)]">
        <Surface className="text-center lg:sticky lg:top-20">
          <div className="mx-auto flex h-28 w-28 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-brand-500 to-indigo-500 text-3xl font-bold text-white ring-4 ring-brand-50">
            {currentUser?.avatarUrl ? (
              ...
              currentUser?.displayName?.slice(0, 1) || <UserRound size={34} />
            )}
          </div>
          ...
          <label className="mt-5 inline-flex cursor-pointer items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-sm font-medium transition hover:bg-slate-50">
            <Upload size={15} />
            更换头像
            <input
              type="file"
          ...
          >
            <form onSubmit={save}>
              <dl className="divide-y divide-slate-100">
                <div className="grid gap-2 py-5 sm:grid-cols-[150px,minmax(0,1fr)] sm:items-center">
