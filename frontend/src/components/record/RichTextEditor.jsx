...
export default function RichTextEditor({ html, onChange, editable = true }) {
  ...
  return <div className="overflow-hidden rounded-xl border border-slate-300/60 bg-white/85 shadow-sm backdrop-blur-sm transition focus-within:border-brand-400 focus-within:shadow-glow">
