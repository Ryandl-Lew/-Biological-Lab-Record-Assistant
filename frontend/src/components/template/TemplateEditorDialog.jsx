...
export default function TemplateEditorDialog({ template, onClose, onSave }) {
  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4"><form onSubmit={submit} className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white/95 p-6 shadow-pop backdrop-blur-sm">
