/**
 * Lightweight SVG charts for Agent fit / plot payloads (no chart-library dependency).
 * Supports bar, line, and scatter (+ optional fitted curve series).
 */
...
export default function DataChart({
  ...
  return (
    <div className="mt-2 overflow-x-auto rounded-lg border border-slate-200 bg-white p-2" role="img" aria-label={title || '数据图'}>
      {title ? <p className="mb-1 px-1 text-xs font-medium text-slate-600">{title}</p> : null}
